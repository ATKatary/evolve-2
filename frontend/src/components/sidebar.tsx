...
function Sidebar({...props}) {
    ...
    let {id, coach, auth, j, sections, header, style, className, selectedStudent, setSelectedStudent, students, isCoach,  ...rest} = props;
            ...
            <div className="flex align-center column" style={{zIndex: 1, padding: 20, marginTop: 100}}>
                ...
                {isCoach?
                    ...
                    <div style={{height: 40}}>
                        ...
                        >
                            <Tooltip title={"nudge"}>
                                <NotificationsActiveRoundedIcon style={{color: selectedStudent? THEME.BUTTON_ACCENT : ""}}/>
                            </Tooltip>
                        </IconButton>
                    </div>
                    </>
